...
BetPlacedModel.watch([], { fullDocument: "updateLookup" }).on("change", function (changeEvent) { return __awaiter(void 0, void 0, void 0, function () { return __generator(this, function (_a) {
    return [2 /*return*/, new DashboardService_1.default({}).logChanges(changeEvent)];
}); }); });
