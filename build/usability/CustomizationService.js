...
var CustomizationService = /** @class */ (function () {
    ...
    CustomizationService.prototype.count = function (condition) {
        return __awaiter(this, void 0, void 0, function () {
            var docs;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, models_1.Customization.countDocuments(__assign({}, (condition && condition))).catch(function (e) { throw e; })];
                    case 1:
                        docs = _a.sent();
    ...
    CustomizationService.prototype.findAllPaginated = function (_a) {
    ...
    CustomizationService.prototype.findAll = function () {
        return __awaiter(this, void 0, void 0, function () {
            var cus;
            return __generator(this, function (_a) {
                switch (_a.label) {
...
exports.default = CustomizationService;
